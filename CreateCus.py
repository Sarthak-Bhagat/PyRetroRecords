...
def CreateCus():
	...
	global NameEnt, UsnEnt, PssEnt,root,PhoneEN
...
def Add():
	...
	username = UsnEnt.get()
	password = PssEnt.get()
	Phone_No = PhoneEN.get()

	

	k = name+' has been added'
	cur.execute( "INSERT INTO Customer(Name, CUsr, CPas, Phone_No) VALUES(\'"+name+"\',\'"+username+"\',\'"+password+"\',\'"+Phone_No+"\')")
	con.commit()
